...
If needed, change the enviromental variables for the frontend and backend in there respective folders.
**Frontend:**
...
### **Step 8:** Retrieve IPs
Retrieve Service IPs with ```Kubectl get service```
